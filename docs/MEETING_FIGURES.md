...
| vs autogram — capability | **ahead** | m=6 vs m=2; autogram cannot checkpoint |
...
- end-to-end training multiplier vs plain SGD
- m=7 with `expandable_segments` — law predicts ~20,777 MiB peak, i.e. it should fit
